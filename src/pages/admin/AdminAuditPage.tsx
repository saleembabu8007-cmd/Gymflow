                ...
                {filteredLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-neutral-800/40 transition-colors">
                    <td className="px-5 py-3.5 font-bold text-white">
                      <span className="px-2 py-0.5 rounded bg-neutral-800 text-rose-400 border border-neutral-700 text-[10px]">
                        {log.action}
                      </span>
                    </td>
                    <td className="px-5 py-3.5 text-neutral-300 font-sans">{log.entityType}</td>
                    <td className="px-5 py-3.5 text-neutral-400">{log.entityId || 'N/A'}</td>
                    <td className="px-5 py-3.5 text-neutral-400">{log.gymId || 'System'}</td>
                    <td className="px-5 py-3.5 text-neutral-400 text-right">
